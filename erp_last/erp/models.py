...
class Incumbent(models.Model) :
    ...
    영문이름 = models.CharField(max_length=30,null=True,blank=True)
    ...
    팀 = models.CharField(max_length=10,null=True,blank=True)
    직급 = models.CharField(max_length=20)
    직책 = models.CharField(max_length=20,null=True,blank=True)
    ...
    학교 = models.CharField(max_length=30,null=True,blank=True)
    ...
    퇴직여부 = models.BooleanField(default=False)
